...
return [
    ...
    |--------------------------------------------------------------------------
    | Cada regla de validación tiene su mensaje correspondiente.
    | El marcador :attribute se reemplaza por el nombre del campo.
    |--------------------------------------------------------------------------
    */
    ...
    'password'             => [
        ...
        'uncompromised' => 'El valor ingresado en :attribute ha aparecido en una filtración de datos. Por favor elige otro.',
    ],
    ...
    |--------------------------------------------------------------------------
    | Aquí puedes definir mensajes específicos para campos concretos del sistema.
    ...
    */
    ...
    'custom' => [
        ...
        'contacto_cli' => [
            ...
            'max'      => 'El número de contacto no puede tener más de :max caracteres.',
        ],
        ...
        'rango_edad' => [
            'required' => 'La clasificación de edad es obligatoria.',
            'in'       => 'La clasificación debe ser TP, +7, +13 o +18.',
        ],

        // Horarios
        'id_pelicula1' => [
            'required' => 'Debes seleccionar una película.',
            'exists'   => 'La película seleccionada no existe.',
        ],
        'id_sala2' => [
        ...
        'tec_proyecc' => [
            ...
            'in'       => 'La tecnología debe ser 2D, 3D o IMAX.',
        ],
        ...
        'id_horario' => [
            ...
            'exists'   => 'El horario seleccionado no existe.',
        ],
        'asientos' => [
            'required' => 'Debes seleccionar al menos un asiento.',
            'array'    => 'Los asientos deben enviarse como lista.',
            'min'      => 'Debes seleccionar al menos un asiento.',
        ],
        'metodo_pago' => [
            'required' => 'El método de pago es obligatorio.',
            'in'       => 'El método de pago debe ser Tarjeta, Efectivo o Transferencia.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Nombres personalizados para los campos (:attribute)
    |--------------------------------------------------------------------------
    | En lugar de mostrar el nombre técnico del campo, se muestra uno legible.
    |--------------------------------------------------------------------------
    */
    ...
    'attributes' => [
        ...
        'correo_cli'       => 'correo electrónico',
        'edad_cli'         => 'edad',
        'contrasena_cli'   => 'contraseña',
        'contacto_cli'     => 'teléfono de contacto',
        'correo_adm'       => 'correo del administrador',
        'contrasena_adm'   => 'contraseña del administrador',
        'nom_pelicula'     => 'nombre de la película',
        'descripcion'      => 'descripción',
        'duracion'         => 'duración',
        'img'              => 'imagen',
        'rango_edad'       => 'clasificación de edad',
        'categorias'       => 'categorías',
        'id_pelicula1'     => 'película',
        'id_sala2'         => 'sala',
        'hora_inicio'      => 'hora de inicio',
        'fecha'            => 'fecha',
        'tec_proyecc'      => 'tecnología de proyección',
        'nom_productos'    => 'nombre del producto',
