...
<div class="container py-5" style="max-width:900px">
    ...
    <div class="mb-4 d-flex align-items-start gap-4">
        ...
        <div>
            <h2 class="fw-bold mb-1">{{ $horario->pelicula->nom_pelicula ?? 'Función' }}</h2>
            <p class="text-secondary mb-0">
                <i class="bi bi-calendar-event text-danger me-2"></i>
                {{ \Carbon\Carbon::parse($horario->fecha)->locale('es')->isoFormat('dddd D [de] MMMM YYYY') }}
                &nbsp;·&nbsp;
            ...
            <p class="text-secondary mb-0 small">
                ...
                {{ $horario->sala->sucursal->nombre_suc ?? '' }}
    ...
    <form action="{{ route('reservas.store') }}" method="POST" id="formReserva">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @if($a->estado === 'Disponible')
                            <button type="button"
                                ...
                                title="{{ $a->num_fila }}{{ $a->num_asiento }}">
                                {{ $a->num_asiento }}
                            </button>
                        @else
        ...
        <div class="mb-4">
            ...
            <p class="text-secondary small mb-3">Agrega snacks a tu reserva y recógelos en la taquilla.</p>
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card-snack" data-precio="{{ $prod->precio_producto }}">
                        ...
                        <div class="card-snack-body">
                            ...
                            <div class="text-secondary" style="font-size:.68rem">Stock: {{ $prod->stock }}</div>
                            {{-- Selector cantidad --}}
                            <div class="d-flex align-items-center justify-content-center gap-2 mt-2">
                                ...
                                <input type="number"
                                       ...
                                       class="snack-qty"
                                       value="0" min="0" max="{{ min($prod->stock, 10) }}"
                                       readonly>
                                <button type="button"
                                        class="btn-qty btn-qty-plus"
                                        data-id="{{ $prod->id_producto }}"
                                        data-max="{{ min($prod->stock, 10) }}">+</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex gap-3">
            <button type="submit" class="btn btn-cine px-4" id="btnConfirmar" disabled>
...
.card-snack:has(.snack-qty:not([value="0"])),
.card-snack.activo {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.btn-asiento.disponible').forEach(btn => {
